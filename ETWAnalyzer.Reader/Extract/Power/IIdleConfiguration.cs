...
namespace ETWAnalyzer.Extract.Power
{
    ...
    /// </summary>
    public interface IIdleConfiguration : IEquatable<IIdleConfiguration>
    {
        /// <summary>
        ...
        /// </summary>
        PercentValue DemoteThresholdPercent { get; }
        ...
        /// </summary>
        TimeSpan MinimumDurationBetweenChecks { get; }
        ...
        /// </summary>
        PercentValue PromoteThresholdPercent { get; }
