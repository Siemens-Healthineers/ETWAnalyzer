...
namespace ETWAnalyzer.Extract.Handle
{
    ...
    public class RefCountChangeEvent : StackEventBase, IRefCountChangeEvent
    {
        ...
        public RefCountChangeEvent(long timeNs, int refCountChange, ETWProcessIndex processIdx, uint threadId, StackIdx stackIdx)
        ...
        /// <param name="threadId"></param>
        public RefCountChangeEvent(long timeNs, int refCountChange, ETWProcessIndex process, uint threadId)
            : this(timeNs, refCountChange, process, threadId, StackIdx.None)
        { }

        /// <summary>
        /// 
        /// </summary>
        public RefCountChangeEvent() : this(0, 0, ETWProcessIndex.Invalid, 0)
        { }
    }
}
