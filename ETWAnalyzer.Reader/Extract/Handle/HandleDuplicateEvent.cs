...
namespace ETWAnalyzer.Extract.Handle
{
    ...
    public class HandleDuplicateEvent : StackEventBase, IHandleDuplicateEvent
    {
        ...
        public HandleDuplicateEvent(long timeNs, ulong handleValue, ulong sourceHandleValue, ETWProcessIndex processIdx, ETWProcessIndex sourceProcessIdx, uint threadId, StackIdx stackIdx)
        ...
        /// 
        /// </summary>
        public HandleDuplicateEvent() : this(0, 0, 0, ETWProcessIndex.Invalid, ETWProcessIndex.Invalid, 0, StackIdx.None)
        { }
    }
}
