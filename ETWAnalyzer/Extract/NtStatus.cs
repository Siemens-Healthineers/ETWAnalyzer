...
{
    /// <summary>
    /// NTStatus definitions from PInvoke.net at https://pastebin.com/p8e1TBVr where the xml comment version is linked
    /// </summary>
...
#pragma warning restore CA1069 // Enums values should not be duplicated
        ...
        // Other Exception codes which are nowhere defined

        /// <summary>
        /// Message Pump Exceptions
        /// </summary>
